!(function () {
  ...
  (t.prototype.initDefaultOptions = function () {
    ...
    (t.prototype.resetActiveMenuItem = function () {
      this.items.htmlForEach(function (t) {
        t.classNameList.remove("active");
      });
    }),
    (t.prototype.changeActiveMenuItem = function (t) {
      t.classNameList.contains("active") ||
        (this.resetActiveMenuItem(), t.classNameList.add("active"));
    }),
