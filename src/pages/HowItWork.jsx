        ...
        <div className="container">
          <div className="row">
            <div className="col-8 mx-auto text-center">
              <h2 className="mb-3 text-capitalize">Cách hoạt động</h2>
              <ul
              ...
              >
                ...
                <li className="list-inline-item">
                  / &nbsp; <a href="how-it-works.html">Cách hoạt động</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="row justify-content-between align-items-center">
            <div className="col-lg-5">
              <div className="section-title">
                ...
                <h1>Khám phá cách dịch vụ của chúng tôi hoạt động.</h1>
                <p>
                  <p>
                    Chúng tôi cung cấp giải pháp nhanh chóng, tiện lợi, giúp bạn
                    hoàn thành công việc chỉ trong vài bước đơn giản.
                  </p>
                  <p>
                    Từ quy trình đăng ký đến triển khai, mọi thứ đều được tối ưu
                    hóa để mang lại trải nghiệm mượt mà và hiệu quả. Hãy cùng
