export default function About() {
  return (
    <>
        ...
        <div className="container">
          <div className="row">
            <div className="col-8 mx-auto text-center">
              <h2 className="mb-3 text-capitalize">Về chúng tôi</h2>
              <ul
            ...
            <div className="col-lg-7">
              <div className="section-title">
                ...
                <h2 className="h1 mb-4">
                  Giá Cả Hợp Lý <br /> Linh Hoạt Theo Nhu Cầu
                </h2>
                <div className="content pe-0 pe-lg-5">
                  <p>
                    Chúng tôi cung cấp các gói dịch vụ thiết kế website và ứng
                    dụng với mức giá cạnh tranh, phù hợp cho cá nhân, startup và
                    doanh nghiệp.
                  </p>
                  <p>
                    Mỗi dự án được tính toán chi phí dựa trên nhu cầu thực tế,
                    đảm bảo tối ưu ngân sách nhưng vẫn giữ chất lượng cao. Không
                    phát sinh chi phí ẩn, minh bạch trong từng giai đoạn thực
                    hiện. Chúng tôi cam kết mang đến giải pháp tối ưu nhất, giúp
                    bạn tiết kiệm chi phí mà vẫn đạt được hiệu quả cao nhất
                    trong kinh doanh.
                  </p>
                </div>
              </div>
          ...
          <div className="row justify-content-around">
            ...
            <div className="col-lg-5">
              ...
              <div className="content">
                <ul>
                  <li>
                    Thiết kế Website: Từ Landing Page đơn giản đến hệ thống quản
      ...
      <section className="section-sm bg-primary-light">
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-4 col-md-6 mb-5 mb-lg-0 text-center icon-box-item">
              <div className="icon icon-lg bg-transparent mb-4">
                <i className="fas fa-mouse-pointer text-primary"></i>
              </div>
              <h3>Xử Lý Nhanh Chóng</h3>
              <p className="px-lg-5">
                Ngay sau khi bạn chọn xong dịch vụ, chúng tôi sẽ lập tức triển
                khai
              </p>
            </div>
            <div className="col-lg-4 col-md-6 mb-5 mb-lg-0 text-center icon-box-item">
              ...
              <h3>Gửi thông tin của bạn</h3>
              <p className="px-lg-5">Thông tin cơ bản, dễ dàng, nhanh chóng</p>
            </div>
            <div className="col-lg-4 col-md-6 mb-5 mb-lg-0 text-center icon-box-item">
              <div className="icon icon-lg bg-transparent mb-4">
                <i className="fas fa-briefcase text-primary"></i>
              </div>
              <h3>Đền Bù Cho Bạn</h3>
              <p className="px-lg-5">
                Chúng tôi sẽ đền bù cho bạn nếu sản phẩm có vấn đề hoặc không
                như bạn yêu cầu
              </p>
            </div>
          </div>
          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="row position-relative gy-4">
                <div className="icon-box-item col-md-6">
                  <div className="block bg-white">
                    <div className="icon rounded-number">01</div>
                    <h3 className="mb-3">Đáng Tin Cậy</h3>
                    <p className="mb-0">
                      Chúng tôi cam kết cung cấp dịch vụ chất lượng, minh bạch
                      và đáng tin cậy.
                    </p>
                  </div>
                </div>
                <div className="icon-box-item col-md-6">
                  <div className="block bg-white">
                    <div className="icon rounded-number">02</div>
                    <h3 className="mb-3">Thấu Hiểu</h3>
                    <p className="mb-0">
                      Chúng tôi lắng nghe và thấu hiểu nhu cầu của bạn, mang đến
                ...
                <div className="icon-box-item col-md-6">
                  <div className="block bg-white">
                    <div className="icon rounded-number">03</div>
                    <h3 className="mb-3">Luôn Cải Tiến</h3>
                    <p className="mb-0">
                      Luôn đổi mới để mang đến giá trị tốt nhất.
                    </p>
                  </div>
                </div>
                <div className="icon-box-item col-md-6">
                  <div className="block bg-white">
                    <div className="icon rounded-number">04</div>
                    <h3 className="mb-3">Người Dùng</h3>
                    <p className="mb-0">
                      Ưu tiên trải nghiệm và nhu cầu của bạn.
                    </p>
                  </div>
                </div>
                <div className="has-shapes">
            ...
            <div className="col-lg-6 mt-5 mt-lg-0">
              <div className="section-title ps-0 ps-lg-5">
                ...
                <h2 className="h1">Giá Trị Cốt Lõi</h2>
                <div className="content">
                  <p>
                    Chúng tôi cam kết cung cấp giải pháp tối ưu, giúp bạn tiếp
                    cận công nghệ dễ dàng và hiệu quả. Với sự linh hoạt, sáng
                    tạo và chất lượng, chúng tôi mang đến dịch vụ chuyên nghiệp,
                    đáp ứng mọi nhu cầu của bạn.
                  </p>
                  <p>
                    Mỗi sản phẩm đều được thiết kế chỉn chu, tối ưu hiệu suất và
                    trải nghiệm, giúp bạn phát triển mạnh mẽ trong môi trường kỹ
                    thuật số.
                  </p>
                </div>
              </div>
            ...
            <div className="col-12">
              <div className="section-title text-center">
                ...
                <p className="mb-0">
                  ...
                  <br />
                  Cam kết mang đến giải pháp và dịch vụ chất lượng cho khách
                  hàng.
                </p>
              </div>
            </div>
