...
export default function Lookup() {
  ...
  let [isLookup, setIsLookup] = useState("");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.get(
        `https://localhost:44336/api/Order/lookup/${orderId}`,
        {
          headers: {
          ...
          <div className="container">
            <div className="row">
              <div className="col-8 mx-auto text-center">
                <h2 className="mb-3 text-capitalize">Tra cứu</h2>
                <ul
              ...
              >
                ...
                >
                  <input
                    type="text"
                    name="orderId"
                    placeholder="Mã đơn đăng ký"
                    className="form-control input-lookup"
                    required
                    onChange={(e) => {
